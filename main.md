...
In onderstaande tabel staan de definities van infiltratievoorzieningen in de kennisbank en het GWSW.

| Voorziening                  | Definitie kennisbank                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              | Definitie GWSW                                                                                                                                                                                                                                             | 
|------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
...
- Het is wenselijk dat onderdelen toegekend kunnen worden een bovenliggende niveau van de infiltratievoorziening. Daarmee kan het functioneren van het geheel van onderdelen worden getoetst (een afwateringsgebied wordt bijvoorbeeld gekoppeld op voorzieningniveau) en is het ook mogelijk om overkoepelende documentatie (geohydrologisch onderzoek bij locatiekeuze, ontwerpen, bestek, revisies, etc.) die ten grondslag liggen aan een infiltratievoorziening daaraan te relateren.

## Afbakening
De beschrijving van de infiltratievoorzieningen focust het perspectief van de hydraulische en constructieve opbouw van een voorziening. Dat houdt in: de voorziening is het geheel der delen, waarbij ieder onderdeel apart wordt beschreven en zijn eigen constructieve en hydraulische kenmerken heeft. Hiermee wordt het mogelijk om de hydraulische werking van de gehele voorziening te schematiseren en is het mogelijk beheeractiviteiten te koppelen aan de onderdelen van de voorziening. 

Hier ligt een belangrijke relatie met GWSW HydX en Wibon. In dit project is uitwisselbaarheid hieromtrent niet nader uitgewerkt.
...
De Infiltrerende wegconstructie is opgenomen als een aparte categorie ten opzichte van de ondergrondse infiltratievoorzieningen. Hiervoor is gekozen vanwege de grote overlap die het heeft met onderdelen die (ook) via de IMBOR worden geregistreerd, echter wel van belangrijke mate van invloed kunnen zijn op het hydraulisch functioneren en beheer van deze voorzieningen.
...
+ Reservoir
  + Infiltratievoorziening
    + Groene infiltratievoorziening
      + Wadi / Infiltratieveld / Infiltratiebassin / Infiltratiegreppel / Infiltratieberm
    + Ondergrondse Infiltratievoorziening
    + Infiltrerende wegconstructie

De concepten Wadi, Infiltratieveld, Infiltratiebassin, Infiltratiegreppel, Infiltratieberm worden synoniemen van elkaar.

De concepten Grindkoffer, Lavakoffer, Steenwolkoffer, Zandkoffer komen te vervallen als zelfstandige concepten. De functionaliteit van deze concepten wordt anders opgelost, zie [Substraat](#substraat).
...
| Groen infiltratieveld | Belastingklasse         | BelastingklasseDIN19580_EN1433 |                                                                                                                        | Ja             |                                                                                                                                                         |
...
| Groen infiltratieveld | Bodemkwaliteit          |                                |                                                                                                                        | Nee            | Opnemen?                                                                                                                                                |
...
Een Infiltratievoorziening kan diverse onderdelen bevatten. Onderstaande tabel toont de diverse onderdelen van een infiltratievoorziening.

| Concept                    | Definitie (indien nieuw)                                                                                                                                                                                                                                       | Reeds in GWSW? | Opmerking              |
|----------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|------------------------|
| Compartiment               |                                                                                                                                                                                                                                                                | Ja             |                        |
| Kolk                       |                                                                                                                                                                                                                                                                | Ja             |                        |
| Slokop                     |                                                                                                                                                                                                                                                                | Ja             |                        |
...
| Infiltratiekrat            | Een ondergrondse ruimte gevuld met individuele kratjes bestemd voor de berging van hemelwater, waarbij het hemelwater door middel van infiltratie door de wanden kan worden afgevoerd.                                                                         | Ja             | Definitie is aangepast |
| Meetinstrument             |                                                                                                                                                                                                                                                                | Ja             |                        |
| Ondergrond                 |                                                                                                                                                                                                                                                                | Ja             |                        |
...
Een Infiltratiekoffer heeft de volgende functies:
...
Een Infiltratiekoffer heeft de volgende onderdelen:
- Substraat
- Omhulling
...
- Doorlaatbaarheid
- Porositeit
- Materiaal substraat, met de volgende opties: Lava, Grind, Zand, Steenwol, Puin, Schelpen en Natuursteen.
...
- Niveua bovenkant filterdeel (in mNAP)
...
De Ondergrondse Infiltratievoorziening is nagenoeg identiek aan Groene infiltratievoorziening. Het verschil is dat de Ondergronde infiltratievoorziening geen Compartiment bevat waar hemelwater wordt geborden, maar enkel ondergrondse objecten. 

## Kenmerken en onderdelen van Infiltrerende wegconstructie

De Infiltrerende wegconstructie is nagenoeg identiek aan Groene infiltratievoorziening. Het verschil is dat de Infiltrerende wegconstructie geen Compartiment bevat waar hemelwater wordt geborgen. In plaats daarvan zijn er diverse soorten verharding, afkomstig uit het IMBOR, onderdeel van deze voorziening. Een Infiltratiegoot (in de praktijk veelal permeoblok genoemd) kan hier ook een onderdeel zijn.
...
Infiltratievoorzieningen zijn objecten op de grenzen van het werkveld van de stedelijk waterbeheerder, groenbeheerder en wegbeheerder. Nadere afstemming over waar welk objecttype registreert is noodzakelijk. Onderstaande tabel toont de raakvlakken van de domeinen.

| Onderdeel                   | Onderdeel IMBOR                      | Definitie                                                                                                                                                                                                                                                                                                                                          |
|-----------------------------|--------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
